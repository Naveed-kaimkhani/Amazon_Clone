  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
          ...
          body: Heath!=null && Womens!=null && Mens!=null && Babies!=null && Sports!=null && Elect!=null? Stack(
            children: [
              SingleChildScrollView(
                ...
                child: Column(
                  ...
                  const  BannerWidget(),
                    ...
                    //   height: 3.h,
                    // ),
                    Product_list(title: "Health and Beauty", children: Heath),
                    Product_list(title: "Women's Fashion", children: Womens),
                    Product_list(title: "Man's Fashion", children:Mens),
                     Product_list(title: "Babies and Toys", children:Babies),
