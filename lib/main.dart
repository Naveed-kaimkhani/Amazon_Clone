...
void main() async{
  ...
  if (kIsWeb) { //kIswWeb is a boolen variable that is true if the app is running on a web browser
    WidgetsFlutterBinding.ensureInitialized();
   await Firebase.initializeApp(  //initialize firebase
      options:const FirebaseOptions(  //initialize firebase options
          ...
          body: Column(
            children: [
              ...
              GestureDetector(
                      ...
                      onTap: () => Navigator.of(context).pushNamed(AppRoutes.authScreen),
